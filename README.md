...
This is a web page where you can add and remove tasks, these are going to be stored in the local storage. 
...
```
  cd my-folder
  git clone git@github.com:myaccount/to-do-list.git 
```
